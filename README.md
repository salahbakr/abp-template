...
```bash
dotnet dev-certs https -v -ep openiddict.pfx -p bba99133-c8b8-41d4-bac2-2a0c3e60107e
```

> `bba99133-c8b8-41d4-bac2-2a0c3e60107e` is the password of the certificate, you can change it to any password you want.
